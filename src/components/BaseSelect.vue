      ...
      <div class="relative">
        ...
        <ListboxButton as="template">
          <div
            ...
            :class="[
              'focus:ring-primary focus:border-primary relative w-full cursor-default rounded-lg border bg-white text-left shadow-sm transition duration-200 focus:outline-none focus:ring-2',
              sizeClass,
        ...
        <teleport to="body">
          <ListboxOptions
            ...
            class="z-50 mt-1 max-h-60 overflow-auto rounded-lg border border-gray-300 bg-white text-sm shadow-lg ring-1 ring-gray-200 focus:outline-none divide-y divide-gray-100"
          >
            <!-- Buscador -->
            <div v-if="searchable" class="border-b border-gray-200">
              <input
                ...
                :disabled="disabled"
                placeholder="Buscar..."
                class="w-full px-3 py-2 text-sm outline-none focus:border-primary disabled:bg-gray-100 disabled:text-gray-400"
              />
            </div>
            ...
            <ListboxOption
              ...
              :disabled="disabled"
              :class="[
                'relative cursor-pointer px-4 py-2.5 select-none first:rounded-t-lg last:rounded-b-lg transition',
                disabled
            ...
            >
              ...
              <span
                ...
                class="absolute inset-y-0 right-4 flex items-center text-primary"
              >
                <Check class="h-4 w-4" />
              </span>
            </ListboxOption>
