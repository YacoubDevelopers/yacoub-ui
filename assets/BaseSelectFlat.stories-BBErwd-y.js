import{_ as a}from"./BaseSelectFlat-DCiT2OQl.js";import"./iframe-CLmCrtQ_.js";import"./preload-helper-D9Z9MdNV.js";import"./listbox-DUrRBSWP.js";import"./chevron-down-FrOaP40-.js";import"./createLucideIcon-BKJMsp_R.js";const d={title:"Base/BaseSelectFlat",component:a,tags:["autodocs"],argTypes:{modelValue:{control:"text"},label:{control:"text"},placeholder:{control:"text"},error:{control:"text"},searchable:{control:"boolean"},options:{control:"object"}}},l={args:{modelValue:null,label:"Selecciona una opción",placeholder:"Elige...",options:[{value:"1",label:"Opción 1"},{value:"2",label:"Opción 2"},{value:"3",label:"Opción 3"}]},render:e=>({components:{BaseSelectFlat:a},setup(){return{args:e}},template:`
      <div class="max-w-xs">
